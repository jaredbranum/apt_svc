...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { address: @apartment.address, baths: @apartment.baths, beds: @apartment.beds, name: @apartment.name, rent: @apartment.rent }
    end
  ...
  test "should update apartment" do
    put :update, id: @apartment, apartment: { address: @apartment.address, baths: @apartment.baths, beds: @apartment.beds, name: @apartment.name, rent: @apartment.rent }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
